          ...
          <div className="glass-card rounded-[2.5rem] w-full max-w-2xl p-8 space-y-6 border-white/10 overflow-y-auto max-h-[90vh] shadow-3xl animate-in zoom-in">
             ...
             <form className="space-y-6" onSubmit={saveBot}>
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    <label className="text-[9px] text-slate-400 font-bold uppercase tracking-widest ml-2">Model</label>
                    <select name="model" defaultValue={editingBot?.model || 'gemini-2.5-flash'} className="w-full bg-white/5 border border-white/10 rounded-xl px-5 py-3 text-white text-xs outline-none focus:border-indigo-500/50 appearance-none">
